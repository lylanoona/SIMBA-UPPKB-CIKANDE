                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="export.php">Laporan Stok Barang</a>
                                    </nav>
                            </div>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    $ambildatastock=mysqli_query($koneksi, "select * from stock where stock < 1");
                                ...
                                <table class="table table-bordered" id="datatablesSimple" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <?php
                                    $ambilsemuadatastock = mysqli_query($koneksi, "SELECT * from stock");
                                    $i = 1;
